...
import com.example.sehs4542group3.savetheblock.savetheblock_GameOver;

public class catchtheball_GameOver extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.catchtheball_game_over);
        ...
        int currentHigh = dbHelper.getHighScore(username, 8);
        if (points > currentHigh) {
            ivNewHighest.setVisibility(View.VISIBLE);
            dbHelper.saveScore(username, 8, points);
        ...
        tohighscore.setOnClickListener(v -> {
            Intent intent = new Intent(catchtheball_GameOver.this, ScoreActivity.class);
    ...
    public void restart(View view) {
        Intent intent = new Intent(catchtheball_GameOver.this, catchtheballActivity.class);
